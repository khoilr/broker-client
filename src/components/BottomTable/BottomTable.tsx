                    ...
                    <table className='min-w-full divide-y divide-gray-200'>
                        ...
                        <tbody className='divide-y divide-gray-200'>
                            <tr>
                                ...
                                <td className='px-6 py-4 text-sm text-gray-800 whitespace-nowrap'>hienpg</td>
                                <td className='px-6 py-4 text-sm text-gray-800 whitespace-nowrap'>0392435608</td>
                                <td className='px-6 py-4 text-sm text-gray-800 whitespace-nowrap'>ADX, EMA</td>
